...
var DataSource = /*#__PURE__*/function (_DataSourceApi) {
  ...
  _createClass(DataSource, [{
    ...
    key: "createQuery",
    value: function createQuery(query, range) {
      var scopedVars = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
      var payload = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_4__["getTemplateSrv"])().replace(query.queryText, Object.assign(Object.assign({}, scopedVars), {
        timeFrom: {
          text: 'from',
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", Promise.all(options.targets.map(function (target) {
                return _this2.createQuery(lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(target, _types__WEBPACK_IMPORTED_MODULE_3__["defaultQuery"]), options.range, options.scopedVars);
                ...
                try {
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    ...
                    var _res$query = res.query,
                      timePath = _res$query.timePath,
                      timeFormat = _res$query.timeFormat,
                    ...
                    var _iterator3 = _createForOfIteratorHelper(dataPathArray),
                      _step3;
                    try {
                      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                        var dataPath = _step3.value;
                        ...
                        try {
                          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                            ...
                            var identifiers = [];
                            var _iterator6 = _createForOfIteratorHelper(groupByList),
                              _step6;
                            try {
                              for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                                var groupByElement = _step6.value;
                            ...
                            if (!dataFrame) {
                              ...
                              for (var _fieldName in doc) {
                                var t = _grafana_data__WEBPACK_IMPORTED_MODULE_2__["FieldType"].string;
                                if (_fieldName === timePath || Object(_util__WEBPACK_IMPORTED_MODULE_6__["isRFC3339_ISO6801"])(String(doc[_fieldName]))) {
                                  t = _grafana_data__WEBPACK_IMPORTED_MODULE_2__["FieldType"].time;
                                } else if (lodash__WEBPACK_IMPORTED_MODULE_5___default.a.isNumber(doc[_fieldName])) {
                                  t = _grafana_data__WEBPACK_IMPORTED_MODULE_2__["FieldType"].number;
                                }
                                var title = void 0;
                                if (identifiers.length !== 0) {
                                  // if we have any identifiers
                                  title = identifiersString + '_' + _fieldName;
                                } else {
                                  title = _fieldName;
                                }
                                if (aliasBy) {
                                  title = aliasBy;
                                  var replaceObject = Object.assign({}, generalReplaceObject);
                                  replaceObject['fieldName'] = _fieldName;
                        ...
                        var _iterator5 = _createForOfIteratorHelper(dataFrameMap.values()),
                          _step5;
                        try {
                          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
                            var _dataFrame = _step5.value;
                            dataFrameArray.push(_dataFrame);
                          }
                        } catch (err) {
                          _iterator5.e(err);
                        } finally {
      ...
      return Promise.all([this.createQuery(query, options.range)]).then(function (results) {
        ...
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            ...
            var _res$query2 = res.query,
              timePath = _res$query2.timePath,
              endTimePath = _res$query2.endTimePath,
              timeFormat = _res$query2.timeFormat;
            var dataPathArray = DataSource.getDataPathArray(res.query.dataPath);
            var _iterator8 = _createForOfIteratorHelper(dataPathArray),
              _step8;
            try {
              for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
                var dataPath = _step8.value;
                var docs = DataSource.getDocs(res.results.data, dataPath);
                var _iterator9 = _createForOfIteratorHelper(docs),
                  _step9;
                try {
                  for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
                    ...
                    var tagsList = [];
                    var _iterator10 = _createForOfIteratorHelper(tags.split(',')),
                      _step10;
                    try {
    ...
    value: function metricFindQuery(query, options) {
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var metricFindValues, payload, response, docs, _iterator11, _step11, doc, fieldName;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              payload = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_4__["getTemplateSrv"])().replace(payload, Object.assign({}, this.getVariables));
              _context2.next = 6;
              return this.postQuery(query, payload);
            case 6:
              response = _context2.sent;
              docs = DataSource.getDocs(response.results.data, query.dataPath);
              _iterator11 = _createForOfIteratorHelper(docs);
              try {
              ...
              return _context2.abrupt("return", metricFindValues);
            case 11:
            case "end":
    ...
    value: function getVariables() {
      ...
      Object.values(Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_4__["getTemplateSrv"])().getVariables()).forEach(function (variable) {
        if (!supportedVariableTypes.includes(variable.type)) {
          console.warn("Variable of type \"".concat(variable.type, "\" is not supported"));
          return;
        }
    ...
    key: "getDocs",
    value: function getDocs(resultsData, dataPath) {
      if (!resultsData) {
    ...
    key: "getDataPathArray",
    value: function getDataPathArray(dataPathString) {
      var dataPathArray = [];
      var _iterator13 = _createForOfIteratorHelper(dataPathString.split(',')),
        _step13;
      try {
        for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
          var dataPath = _step13.value;
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var GraphQLAnnotationsQueryCtrl = /*#__PURE__*/_createClass(function GraphQLAnnotationsQueryCtrl() {
  _classCallCheck(this, GraphQLAnnotationsQueryCtrl);
});
...
var QueryEditor = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(QueryEditor, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["QueryField"], {
        query: queryText || '',
        ...
        }, "Optional time format in moment.js format.\xA0", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Icon"], {
...
var VariableQueryEditor = function VariableQueryEditor(_ref) {
  var onChange = _ref.onChange,
    query = _ref.query;
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(query),
    _useState2 = _slicedToArray(_useState, 2),
    state = _useState2[0],
    setState = _useState2[1];
  var saveQuery = function saveQuery() {
    onChange(state, "".concat(state.queryText, " (").concat(state.dataPath, ")"));
  };
  var onChangeQuery = function onChangeQuery(value, override) {
    return setState(Object.assign(Object.assign({}, state), {
      queryText: value
    }));
  };
  var handleChange = function handleChange(event) {
    return setState(Object.assign(Object.assign({}, state), _defineProperty({}, event.currentTarget.name, event.currentTarget.value)));
  };
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    className: "gf-form-label width-10"
  }, "Query"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__["QueryField"], {
...
function flatten(object) {
  ...
  return Object.keys(object).reduce(function (acc, key) {
    ...
    return isObject ? Object.assign(Object.assign({}, acc), flatten(object[key], newPath, separator)) : Object.assign(Object.assign({}, acc), _defineProperty({}, newPath, object[key]));
  }, {});
}
function isRFC3339_ISO6801(str) {
  var date = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_0__["dateTime"])(str, _grafana_data__WEBPACK_IMPORTED_MODULE_0__["ISO_8601"]);
  if (date.isValid()) {
